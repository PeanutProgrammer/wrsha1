...
const SecurityCivillians = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = () => {
      axios
        .get("http://localhost:4001/civillian/tmam", {
  ...
  //           body: [
  //             [
  //               { text: 'الرقم القومي', style: 'tableHeader' },
...
// Export to Word
const exportToWord = () => {
  const table = document.getElementById('civillian-table');
  if (table) {
        ...
        <table style="width: 100%; border-collapse: collapse; margin-top: 20px;">
          <thead>
            <tr style="background-color: #f2f2f2;">
              <th style="border: 1px solid black; padding: 5px;">الرقم القومي</th>
...
export default SecurityCivillians;

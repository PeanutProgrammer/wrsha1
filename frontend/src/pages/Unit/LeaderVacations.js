...
const LeaderVacations = () => {
  ...
  useEffect(() => {
    const fetchData = () => {
      ...
      const url = `${process.env.REACT_APP_BACKEND_BASE_URL}/unit/vacations?page=${units.page}&limit=${units.limit}&search=${searchValue}&type=${units.selectedType}&filterReturningToday=${units.filterReturningToday}`;
  ...
  return (
    <div className="Officers p-5">
      ...
      <div className="header d-flex flex-wrap justify-content-between align-items-center mb-3 gap-2">
        <h3 className="text-white"> اجازات الوحدة </h3>
...
export default LeaderVacations;

...
const ManageCourse = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = () => {
      ...
      const resp = axios
        .get(
          `${process.env.REACT_APP_BACKEND_BASE_URL}/officer/courses?page=${officers.page}&limit=${officers.limit}&search=${searchValue}`,
          {
  ...
  return (
    <div className="Officers p-5">
      ...
      <div className="header d-flex flex-wrap justify-content-between align-items-center mb-3 gap-2">
        {/* Page Title */}
        <h3 className="text-white">إدارة فرق / دورات الضباط</h3>

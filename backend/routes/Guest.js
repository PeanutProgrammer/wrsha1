...
router.post(
  ...
  body("rank")
    .isString()
    .withMessage("من فضلك أدخل رتبة / درجة صحيحة")
    .isLength({ min: 3, max: 30 })
    .withMessage("الرتبة يجب أن تكون بين 3 و 30 حرفًا"),
  body("name")
    .isString()
  ...
  body("unit")
    .isString()
    .withMessage("من فضلك أدخل اسم وحدة / شركة صحيحة")
    .optional(),
  ...
  body("visit_to").isString().withMessage("من فضلك أدخل اسم ضابط صحيح"),

  body("reason").isString().withMessage("من فضلك أدخل سبب الزيارة صحيح"),
...
router.put(
  ...
  body("unit")
    ...
    .withMessage("من فضلك أدخل اسم وحدة / شركة صحيحة")
    .isLength({ min: 3, max: 30 })
    .withMessage("الوحدة يجب أن تكون بين 3 و 30 حرفًا"),
  ...
  body("visit_to")
    ...
    .isLength({ min: 3 })
    .withMessage("اسم الضابط  يجب أن تكون على الأقل 3 أحرف"),
